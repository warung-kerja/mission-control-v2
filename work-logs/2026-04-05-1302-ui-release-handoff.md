...
- Blocking checks: **3**
- Snapshot timestamp: **2026-04-05T13:01:54+1000**
...
# Assert smoke evidence contains expected web directory path from one-pass pre-gate check
npm run release:ui-gate
```

## Handoff Artifacts

- Timestamped handoff path: `/mnt/d/Warung Kerja 1.0/06_Agents/noona/projects/mission-control/mission-control-v2/work-logs/2026-04-05-1302-ui-release-handoff.md`
...
- Timestamped script path: `/mnt/d/Warung Kerja 1.0/06_Agents/noona/projects/mission-control/mission-control-v2/work-logs/2026-04-05-1302-ui-release-one-pass.sh`
