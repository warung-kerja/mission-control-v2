...
for REQUIRED_PRE_GATE_ARTIFACT in work-logs/latest-ui-release-readiness.json work-logs/latest-ui-release-readiness-report.json work-logs/latest-ui-release-handoff-bundle-manifest.json work-logs/latest-ui-release-handoff.md work-logs/latest-ui-release-operator-brief.md work-logs/latest-ui-release-one-pass.sh; do
...
export RELEASE_GATE_RUN_TOKEN RELEASE_GATE_EXPECTED_COMMIT RELEASE_GATE_EXPECTED_BRANCH RELEASE_GATE_EXPECTED_READINESS_TIMESTAMP RELEASE_GATE_EXPECTED_READINESS_STATUS RELEASE_GATE_EXPECTED_BLOCKING_CHECKS RELEASE_GATE_EXPECTED_READINESS_SHA256 RELEASE_GATE_EXPECTED_READINESS_REPORT_JSON_SHA256 RELEASE_GATE_EXPECTED_BUNDLE_MANIFEST_SHA256 RELEASE_GATE_EXPECTED_HANDOFF_SHA256 RELEASE_GATE_EXPECTED_OPERATOR_BRIEF_SHA256 RELEASE_GATE_EXPECTED_ONE_PASS_SHA256
for REQUIRED_GATE_METADATA_VAR in RELEASE_GATE_EXPECTED_COMMIT RELEASE_GATE_EXPECTED_BRANCH RELEASE_GATE_EXPECTED_READINESS_TIMESTAMP RELEASE_GATE_EXPECTED_READINESS_STATUS RELEASE_GATE_EXPECTED_BLOCKING_CHECKS RELEASE_GATE_EXPECTED_READINESS_SHA256 RELEASE_GATE_EXPECTED_READINESS_REPORT_JSON_SHA256 RELEASE_GATE_EXPECTED_BUNDLE_MANIFEST_SHA256 RELEASE_GATE_EXPECTED_HANDOFF_SHA256 RELEASE_GATE_EXPECTED_OPERATOR_BRIEF_SHA256 RELEASE_GATE_EXPECTED_ONE_PASS_SHA256; do
