...
- Generated: 2026-03-26 02:00 AM (AEDT)
- Readiness snapshot: `work-logs/latest-ui-release-readiness.json`
- Current status: **NOT_READY**
- Blocking checks: **3**
- Snapshot timestamp: **2026-03-25T22:01:39+1100**
- Snapshot age: **239 min** (stale)

> ⚠️ Snapshot is older than 120 minutes. Re-run `npm run release:ui-readiness` before executing the gate.
